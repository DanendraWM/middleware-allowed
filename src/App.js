...
function App() {
  ...
  const kirim = (e) => {
    ...
    window.location.href = `https://api.whatsapp.com/send?phone=6282260156193&text======= *Izin Ke Middleware* ======%0a%0a%0aTanggal : ${tanggalNow}%0aNama : ${nama}%0ainstansi : ${instansi}%0aTujuan : ${tujuan}%0aKeterangan : ${desc}%0a%0aTerima Kasih`;
  };
  return (
    <div className="min-h-screen bg-slate-300 text-black">
      <div className=" flex flex-row w-full text-center bg-[#f5f2f2] shadow-[0_15px_20px_-20px_rgba(0,0,0,0.5)] rounded-b-lg rounded-t-none">
        <div className="card-body font-bold font-serif ">WP Team</div>
          ...
          <div className="card lg:w-2/3 w-4/5 bg-white shadow-[0_25px_20px_-20px_rgba(0,0,0,0.5)]">
            <div className="card-body">
              ...
              >
                ...
                <option value="Dismantle Perangkat">Dismantle Perangkat</option>
              </select>
            </div>
          </div>
          <div className="card lg:w-2/3 w-4/5 bg-white shadow-[0_25px_20px_-20px_rgba(0,0,0,0.5)]">
