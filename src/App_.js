...
function App() {
  let firstTime = formatISO9075(new Date(), {
    representation: "time",
  });
  let endTime = formatISO9075(addHours(new Date(), 5), {
    representation: "time",
  });
  ...
  const kirim = (e) => {
    ...
    window.location.href = `https://api.whatsapp.com/send?phone=6285156834452&text======= *Izin Ke Middleware* ======%0a%0a%0aTanggal : ${tanggalNow}%0aDari Jam : ${firstT}%0aSampai Jam : ${endT}%0aNama : ${nama}%0ainstansi : ${instansi}%0aTujuan : ${tujuan}%0aKeterangan : ${desc}%0a%0aTerima Kasih`;
  };
  return (
    <div className="min-h-screen bg-slate-300 text-black">
      <div className=" flex flex-row w-full text-center bg-[#f5f2f2] shadow-[0_15px_20px_-20px_rgba(0,0,0,0.5)] rounded-b-lg rounded-t-none">
        <div className="card-body font-bold font-serif ">asijdhadsidauisadhu Team</div>
        <div className="card-body font-semibold font-sans">
      ...
      <form onSubmit={kirim}>
        <div className="flex flex-col py-4 space-y-4 justify-center items-center">
          ...
          <div className="card lg:w-2/3 w-4/5 bg-white shadow-[0_25px_20px_-20px_rgba(0,0,0,0.5)]">
            <div className="card-body">
              <h2 className="card-title">*Instansi</h2>
              <input
                className="bg-transparent  text-black border-black focus:outline-none border-b-2 lg:w-1/3"
                type="text"
                placeholder="Telkom"
          ...
          <div className="card lg:w-2/3 w-4/5 bg-white shadow-[0_25px_20px_-20px_rgba(0,0,0,0.5)]">
            <div className="card-body">
              <h2 className="card-title">*waktu</h2>
              ...
              <div className="lg:flex lg:space-y-0 lg:space-x-6 space-y-10">
                <div className="flex-col w-1/2">
                  ...
                  <input
                    ...
                    readOnly
                    value={firstTime}
                    onChange={(e) => setFirstT(e.target.value)}
                  />
                </div>
                <div className="flex-col w-1/2">
                  ...
                  <input
                    className="bg-transparent  text-black border-black focus:outline-none border-b-2 w-full"
                    type="time" id="appt" name="appt" min={firstTime} max="23:59" required
